...
$applyData = $db->Select("SELECT tbl_job_apply.*,tbl_job_seekers.username,tbl_job_categories.category_name,tbl_companies.company_name as cmp_name FROM tbl_job_apply
